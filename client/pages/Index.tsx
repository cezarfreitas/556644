            ...
            <div className="text-center mt-16">
              <div className="space-y-6">
                ...
                <p className="text-gray-300 max-w-2xl mx-auto">
                  Venha ao nosso showroom em São Paulo ou cadastre-se agora para receber todas as informações sobre como se tornar um lojista oficial.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center border-2 border-primary text-primary hover:bg-primary hover:text-white px-8 py-3 rounded-lg font-bold text-lg transition-colors duration-300 gap-2"
                  >
